...
Route::get('/redirect',[App\Http\Controllers\Home\OrdersController::class,'redirect']);
...
Route::middleware('auth:users')->group(function () {
    ...
    Route::get('/user/order/pay', [App\Http\Controllers\Home\OrdersController::class,'pay'])->name('home.order.pay');
...
Route::prefix('Admin')->middleware('auth:admins')->group(function () {
    ...
    Route::match('menus', App\Http\Controllers\Admin\MenusController::class);
...
Route::namespace('PayCallBack')->group(function () {
    ...
    Route::any('/paypal', [App\Http\Controllers\PayCallBack\PaymentController::class,'payment']); // 回调地址  [/api/payment/wechat/web] | [/api/payment/alipay/mini]
